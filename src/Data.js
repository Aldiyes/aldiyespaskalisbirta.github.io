import imgMisa1 from "./images/misa (1).jpg";
import imgMisa2 from "./images/misa (2).jpg";
import imgMisa3 from "./images/misa (3).jpg";
import imgMisa4 from "./images/misa (4).jpg";
import imgMisa5 from "./images/misa (5).jpg";
import imgMisa6 from "./images/misa (6).jpg";
import imgMisa7 from "./images/misa (7).jpg";
import imgMisa8 from "./images/misa (8).jpg";
import imgML1 from "./images/mobile_legend (1).jpg";
import imgML2 from "./images/mobile_legend (2).jpg";
import imgML3 from "./images/mobile_legend (3).jpg";
import imgML4 from "./images/mobile_legend (4).jpg";
import imgML5 from "./images/mobile_legend (5).jpg";
import imgTalkShow1 from "./images/talk_show (1).jpg";
import imgTalkShow2 from "./images/talk_show (2).jpg";
import imgTalkShow3 from "./images/talk_show (3).jpg";
import imgTalkShow4 from "./images/talk_show (4).jpg";
import imgTalkShow5 from "./images/talk_show (5).jpg";
import imgWebinar1 from "./images/webinar (1).jpg";
import imgWebinar2 from "./images/webinar (2).jpg";
import imgWebinar3 from "./images/webinar (3).jpg";
import imgWebinar4 from "./images/webinar (4).jpg";
import imgWebinar5 from "./images/webinar (5).jpg";
import imgWebinar6 from "./images/webinar (6).jpg";
import imgWebinar7 from "./images/webinar (7).jpg";
import imgWebinar8 from "./images/webinar (8).jpg";
import imgBlindDate1 from "./images/blind_date (1).jpg";
import imgBlindDate2 from "./images/blind_date (2).jpg";
import imgBlindDate3 from "./images/blind_date (3).jpg";
import imgBlindDate4 from "./images/blind_date (4).jpg";
import imgBlindDate5 from "./images/blind_date (5).jpg";
