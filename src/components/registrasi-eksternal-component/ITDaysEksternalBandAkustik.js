...
import { ITDaysEksternalBandAkustik } from "../../Data";
                    ...
                    <div className="box box-sistem-pertandingan">
                      ...
                      <ul className="meliputi-custom">
                        {item.penilaianMeliputi.map((meliputi, index) => (
                          <li className="description" key={index + 4}>
                            {meliputi}
                          </li>
                        ))}
                      </ul>
